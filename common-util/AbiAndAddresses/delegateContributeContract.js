...
export const DELEGATE_CONTRIBUTE_ABI = [{ inputs: [{ internalType: 'address', name: '_veOLAS', type: 'address' }], stateMutability: 'nonpayable', type: 'constructor' }, { inputs: [{ internalType: 'address', name: 'delegator', type: 'address' }, { internalType: 'address', name: 'delegatee', type: 'address' }], name: 'AlreadyDelegatedToSameDelegatee', type: 'error' }, { inputs: [{ internalType: 'address', name: 'delegator', type: 'address' }], name: 'NoBalance', type: 'error' }, { inputs: [{ internalType: 'address', name: 'delegator', type: 'address' }], name: 'NoSelfDelegation', type: 'error' }, {
  ...
  inputs: [{ internalType: 'address', name: 'delegatee', type: 'address' }], name: 'getDelegatorList', outputs: [{ internalType: 'address[]', name: '', type: 'address[]' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [{ internalType: 'address', name: '', type: 'address' }], name: 'mapDelegation', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [], name: 'veOLAS', outputs: [{ internalType: 'address', name: '', type: 'address' }], stateMutability: 'view', type: 'function',
}, {
  inputs: [{ internalType: 'address', name: 'delegatee', type: 'address' }], name: 'votingPower', outputs: [{ internalType: 'uint256', name: 'totalVotingPower', type: 'uint256' }], stateMutability: 'view', type: 'function',
}];
